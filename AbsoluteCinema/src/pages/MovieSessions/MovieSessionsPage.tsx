...
const mapApiSessionToSession = (
    ...
    return {
        ...
        date: apiSession.date || apiSession.startDateTime || apiSession.startTime || '',
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const mappedMovie = await mapMovieDetailsFromApi(movieData);
                setMovie(mappedMovie);

                const sessionsResponse = await getMovieSessions(id);
